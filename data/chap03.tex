...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap03/畸变和alpha_beta之间的关系.pdf}
    \caption{畸变和𝛼、𝛽之间的关系}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap03/相对畸变和xn_yn之间的关系.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap03/不同alpha的情况下beta变化导致的畸变变化.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap03/beta变化导致的像点最大偏移.pdf}
