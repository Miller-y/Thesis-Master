...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap04/Y型光学定位传感器（LOPS）系统结构示意图.pdf} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/chap04/柱面镜头组原理图.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap04/一维小孔成像模型.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap04/理想光斑信号模型.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap04/实际光斑信号.pdf}
...
\begin{figure}[htbp]
    \centering
    % 注意：保持了您原有的图片路径
    \includegraphics[width=0.4\textwidth]{figures/chap04/坐标系I、坐标系P和坐标系C之间的关系.pdf}
    \caption{像素坐标系示意图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap04/坐标系S和世界坐标系W之间的关系.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap04/传统线阵CCD布局.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/chap04/Y型定位传感器模型.pdf}
